...
**シーン 5: 患者説明文の根拠裏付け** — AI判定結果を患者に説明する場面で、サイト hero 検索「透明性」「同意プライバシー」「説明責任」で WHO / 厚労省 / 日本医師会 ガイドラインの該当箇所を確認し、本テンプレで説明文を起草します。院内倫理委員会または上席医のレビューを経て確定版を運用してください。詳しい流れは [使い方シナリオ #5](../usage.md#5) を参照。
