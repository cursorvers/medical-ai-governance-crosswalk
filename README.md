...
1. [GitHub Pages](https://cursorvers-inc.github.io/medical-ai-governance-crosswalk/) を開く (構築中)
2. ガイドライン名 or 論点名で検索
...
GitHub Pages では Evidence ページから各 Markdown をダウンロードします。ページ本体は `site/docs/evidence.md` として生成され、公開後は `https://cursorvers-inc.github.io/medical-ai-governance-crosswalk/evidence/` 配下のファイルへリンクします。ローカルでは `build/evidence/<template>.md` を確認してください。
...
```bash
git clone https://github.com/cursorvers-inc/medical-ai-governance-crosswalk.git
...
- 引用例: `Cursorvers Inc. (2026). Medical AI Governance Crosswalk. https://github.com/cursorvers-inc/medical-ai-governance-crosswalk`
