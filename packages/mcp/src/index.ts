...
function asTextContent(result: unknown): { content: Array<{ type: "text"; text: string }> } {
  return {
  ...
  tools: [
    {
      ...
      description:
        "Search the medical AI governance crosswalk (PMDA/FDA/EU AI Act/WHO/IMDRF/ISO-IEC 42001/NIST AI RMF/MHLW/METI/JMA). Returns matching columns and cells with citations and strength labels.",
      inputSchema: {
        type: "object",
        properties: {
